      ...
      <div style={{ display: "flex", gap: 24, alignItems: "center", justifyContent: "space-between", background: "linear-gradient(180deg, rgba(255,255,255,0.02), rgba(255,255,255,0.01))", padding: 28, borderRadius: 12, boxShadow: "0 16px 40px rgba(2,6,23,0.6)" }}>
        <div style={{ flex: 1 }}>
          ...
          <div style={{ marginTop: 18, display: "flex", gap: 12 }}>
            <button onClick={onCTAClick} style={{ background: "linear-gradient(90deg,#38bdf8,#0ea5e9)", color: "#021124", padding: "10px 14px", borderRadius: 10, fontWeight: 700 }}>
              View Projects
            </button>
            <a href="/Siddharth.pdf" download>
              <button style={{ background: "transparent", border: "1px solid rgba(255,255,255,0.06)", color: "#cfeffa", padding: "10px 14px", borderRadius: 10 }}>
                Resume
              </button>
            </a>
          </div>
